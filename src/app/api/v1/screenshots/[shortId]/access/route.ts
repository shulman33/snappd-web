/**
 * GET /api/v1/screenshots/[shortId]/access
 *
...
export async function GET(request: NextRequest, context: RouteContext) {
  try {
        ...
        return NextResponse.json(
          {
            ...
            verifyEndpoint: `/api/v1/screenshots/${shortId}/verify-password`
          },
          { status: 401 }
        )
    ...
    console.error('Error in /api/v1/screenshots/[shortId]/access:', error)
